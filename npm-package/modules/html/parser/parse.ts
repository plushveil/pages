...
import getTemplateLiterals from './get-template-literals.js'
...
/**
 * @typedef {import('./get-template-literals.js').TemplateLiteral} TemplateLiteral
 */

/**
 * @typedef {import('./get-text-nodes.js').TextNode} TextNode
 */
 ...
 * @property {() => globalThis.Iterable<import('./iterator.js').Node>} iterator Iterate over all nodes in the HTML document
 */
