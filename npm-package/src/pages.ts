...
import * as css from '../modules/css/css.js'
import * as html from '../modules/html/html.js'
import * as js from '../modules/js/js.js'
 ...
 * @param {string | import('./config.js').Config} [config] - A specifier that points to the configuration file or the configuration itself.
