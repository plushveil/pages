...
import sitemap from './modules/buildtools/sitemap.js'
 ...
 * @type {URL}
 */
export { baseURI } from './src/config.js'
 ...
 * @property {(output: string, config: import('./src/config.js').Config) => Promise<void>} [after] - A function to run after the build.
 */
/**
 * @type {BuildConfig}
 */
